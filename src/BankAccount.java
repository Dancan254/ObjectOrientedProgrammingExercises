...
public class BankAccount {
    ...
    public BankAccount(CreateAccount customer) {// parameters
        // this keyword -> use to refer to the current instance -parameter name equals
        // the instance variable name
        this.nameOfHolder = customer.getFirstName() + " " + customer.getLastName();
